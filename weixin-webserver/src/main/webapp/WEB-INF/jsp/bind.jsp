...
<script type="text/javascript">  
    ...
    $(document).ready(function(){  
        ...
        $("#submit").click(function(){  
            ...
            var user = {"userid":userid,"username":username,"password":password};  
...
<body>
	...
	<div class="page-container" style="margin-top: 15px">
		...
		<form action="" method="post">
			<input type="text" name="userid" id="userid" class="username" value="${UserId}"
				placeholder="微信ID" readonly="readonly"> 
<%-- 				<input type="text" name="userid" id="userid" class="username" value="${UserId}" --%>
<!-- 				placeholder="微信ID" >  -->
				<input type="text"
				name="username" class="username" id="username" placeholder="域账号"> <input
				type="password" name="password" id="password" class="password" placeholder="密码">
